...
% D0 = 7; %This is the standard deviation, in pixels, of the 
...
%D0 = 0.07*PQ(1); -> more of LP filter
%D0 = 0.05*PQ(1); -> more of like 50 -50
% 0.03 -0.35 is accurate
D0 = 0.03*PQ(1);
%D0 = 0.01*PQ(1); -> more of HP filter
lowpass_filter = lpfilter('gaussian', PQ(1), PQ(2), D0);
%Image 2
PQ = paddedsize(size(Img2));
D0 = 0.03*PQ(1);
highpass_fitler = hpfilter('gaussian', PQ(1), PQ(2), D0);
...
low_frequencies = my_filter(Img1, lowpass_filter);%% the second paramenter is cutoff freq
...
high_frequencies = my_filter(Img2, highpass_filter);
